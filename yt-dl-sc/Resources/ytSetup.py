#!/bin/python3 
import os, sys, json, time, pymongo
...
class yt_Program_Setup: 
    ...
    def __init__(self): 
        ...
        self._API_KEY = None 
        self._DataBase, self._Collection, self._Vid_HistoryDataBase = None, None, None 
        self._YT_Conn = None 
    ...
    def __setupLog(self): 
        ...
        # Create the log file 
        self._LogFile = LOGGING(os.path.join(self._LogsFolder, time.strftime("%Y%d%m-%H%M")))
    ...
    def loadConnections(self): 
        ...
        self._DataBase = self.JSONFILE["URLS"]["MongoDB"]
